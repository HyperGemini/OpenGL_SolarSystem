...
void Gui::button(const std::string &label, const std::string &info,
                 bool *value) {
...
FocusState Gui::getFocusState() const { return focusState; }

float Gui::getTimeScale() const { return timeScale; }

float Gui::getLightIntensityScale() const { return lightIntensityScale; }

float Gui::getVolumeScale() const { return volumeScale; }

const float *Gui::getColors() const { return colors; }
