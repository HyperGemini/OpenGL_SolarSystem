...
Sphere::Sphere(Loader *loader, const Texture &texture,
               const glm::vec3 &position, float rotX, float rotY, float rotZ,
               float scale)
        : Entity(
        TexturedModel(OBJLoader::loadObjModel(Resources::OBJ_SPHERE, loader),
                      texture),
